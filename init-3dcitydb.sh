...
sudo -u postgres psql -d $DB_NAME -c "CREATE EXTENSION postgis_raster;"
...
source 3dcitydb-4.4.0/postgresql/ShellScripts/Unix/CONNECTION_DETAILS.sh
...
cd 3dcitydb-4.4.0/postgresql/SQLScripts
